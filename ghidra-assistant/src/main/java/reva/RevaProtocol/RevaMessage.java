...
public class RevaMessage {
    ...
    static {
        ...
        messageTypes.add(RevaExplain.class);
        messageTypes.add(RevaExplainResponse.class);
        messageTypes.add(RevaSetComment.class);
        messageTypes.add(RevaSetCommentResponse.class);
    }
