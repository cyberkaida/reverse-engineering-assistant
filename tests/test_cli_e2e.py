...
pytestmark = [pytest.mark.cli, pytest.mark.e2e, pytest.mark.slow, pytest.mark.asyncio]
...
class TestMCPToolCalls:
    ...
    async def test_list_tools(self, mcp_stdio_client):
        ...
        assert "list-functions" in tool_names
...
class TestErrorHandling:
    ...
    async def test_handles_unknown_tool(self, mcp_stdio_client):
        ...
        with pytest.raises(Exception):  # MCP will raise an exception
