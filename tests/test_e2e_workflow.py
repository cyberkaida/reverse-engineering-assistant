...
# collision (test_arm64, test_arm64.0, ...), and every test here already
# operates on the returned importedPrograms path, so the copies stay
# independent. See conftest.mcp_stdio_client_session.
